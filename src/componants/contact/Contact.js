...
const Contact = () => {
    ...
    const sendEmail = (e) => {
      ...
      emailjs.sendForm('service_fmc879i', 'template_glb3lfd', form.current, 'OlboAqvFcHnCXQ1BM')
      e.target.reset()
    };
          ...
          <div className="contact__content">
            ...
            <div className="contact__info">
              ...
              <div className="contact__card">
                ...
                <span className="contact__card-data">6392641968</span>
                <a
                  href="https://api.whatsapp.com/send?
                phone=6392641968&text=hello, more informaation!
                "
                  className="contact__button"
                >
                  Write Me
              ...
              <div className="contact__card">
                <AiFillTwitterCircle className="contact__card-icon" />
                <h3 className="contact__card-title">Twitter</h3>
                <span className="contact__card-data">AmanTrivedi_10</span>
                <a
